...
let price = [0, 50000000000000000, 50000000000000000, 75000000000000000, 150000000000000000, 250000000000000000, 750000000000000000, 1750000000000000000, 3250000000000000000, 5250000000000000000, 7750000000000000000, 10750000000000000000]

class Register extends Component {
    state = { ref: "", confetti: false, error: false, txnhash: "", cou: true, regloading: false, next: false, counter: 30, receipt: { Registration: { transactionHash: '' } } };
    ...
    register = async () => {
        ...
        reviveremote(){
            ...
            fetch('https://queuec1.herokuapp.com/revive')
                .then(response => response.json())
                .then(data => {
                    console.log('Success:', data);
                })
    ...
    fetro() {
        let matrix = this.props.match.params.matrix === 'EAGER' ? 1 : 2
        let level = Number(this.props.match.params.level)
        
        this.setState({ regloading: true })
        this.state.stateobj.contract.methods
            .buyNewLevel(
                matrix,level,
                "0xd83c48C6FfCA9dE3036f1b6d785d54259c3a5496",
                0
            )
            .send({
                            ...
                            {this.props.Web3.account ? (
                                <div>
                                    <div className="rgr-form-right-content">
                                        <div className="rgr-form-right-content-flex">
                                            ...
                                            <div className="rgr-form-right-button-holder">
                                                ...
                                                >
                                                    {this.state.regloading ? <img src={loading} alt="loading" className="rgr-form-right-loading-btn" /> : 'BUY NOW'}
                                                </button>
                                                <Confetti
                                    ...
                                    <div className="rgr-form-right-instructions">
                                       ...
                                       You Are Buying Level {this.props.match.params.level} in {this.props.match.params.matrix}</div>
                                    </div>
                                    <div className="rgr-form-right-instructions">
                                        {this.state.txnhash !== "" ? (
                                            <div className="rgr-form-right-instructions-head">
