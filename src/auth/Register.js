...
class Register extends Component {
  ...
  register = async () => {
    fetch(`https://mainserve.herokuapp.com/auth/referrer/${this.state.ref}`)
      .then((response) => response.json())
      .then((data) => {
        if (data.response === "User Found") {
          this.fetro(data.address)
          this.setState({ isunknown: false, isprocessing: false });
                  ...
                  <div className="rgr-form-right-content">
                    <div className="rgr-form-right-content-flex">
                      ...
                      <div className="rgr-form-right-button-holder">
                        ...
                        >
                          {this.state.regloading ? <img src={loading} alt="loading" className="rgr-form-right-loading-btn" /> : 'REGISTER'}
                        </button>
                        <Confetti
