...
const mapDispatchToProps = (dispatch) => {
 ...
 class InvoiceDesk extends Component {
                ...
                { 
                    this.state.isloading ? <div className='loading-flex'><img src={loading_anime} alt="loading" className="loading-anime" /></div> : <div className="grid-container-lg">
                        <div className="lg-sidebar">
                            <Sidebar address={this.props.match.params.useraddress} high={'invoice'}/>
                        </div>
...
export default connect(mapStateToProps, mapDispatchToProps)(InvoiceDesk)